...
// if (loveScore > 55){
//     alert("Your love score is " + loveScore + "% chyragym! Masha Allah, may Allah bless You!");
//     console.log("Your love score is " + loveScore + "% chyragym!Masha Allah, may Allah bless You!");
// }
// if (loveScore > 15 && loveScore <= 55) {
//     alert("Your love score is " + loveScore + "% chyragym! This is the harmony life!");
//     console.log("Your love score is " + loveScore + "% chyragym! This is the harmony life!");
// }
// if (loveScore <= 15) {
